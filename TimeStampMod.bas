Attribute VB_Name = "TimeStampMod" ' avoids name conflct with function
'###############################################################################
'#
'# Visual Basic module "TimeStampMod.bas"
...
Do: nw = Now(): sec = Timer(): Loop Until nw = Now(): hrs = Int(sec / 3600!)
...
Public Sub NowInc()
Dim nw As Double, k As Long
For k = 1 To 4
  Do: nw = Now(): Loop Until nw = Now()
  Debug.Print nw; " ";
  Debug.Print
Next k
End Sub
